...
public class STDModbusMaster {
    ...
    public STDModbusResponse StandardManualWordRead_F3(int Slave, int StartAddr, int Length, int waitMillisecond) {
        ...
        data = STDModbusCommon.bulid_read_registers(Slave, MDFunction.MODBUS_FC_READ_HOLDING_REGISTERS, StartAddr,
                Length);
    ...
    public STDModbusResponse StandardManualWordWrite_F10(int Slave, int StartAddr, byte[] Values,
        ...
        data = STDModbusCommon.bulid_write_registers(Slave, MDFunction.MODBUS_FC_WRITE_MULTIPLE_REGISTERS, StartAddr,
                Values);
